                      ...
                      return GestureDetector(
                        onTap: () {
                          Map<String, dynamic> callDisconnect = {
                            'role': "customer",
                            'callerId': logic.callerId != Constant.storage.read("customerId") ? logic.receiverId : logic.callerId,
                            'receiverId':
                                logic.receiverId == Constant.storage.read("customerId") ? logic.callerId : logic.receiverId,
                            'callId': logic.callId,
