...
GetFilterWiseAgencyModel getFilterWiseAgencyModelFromJson(String str) => GetFilterWiseAgencyModel.fromJson(json.decode(str));
String getFilterWiseAgencyModelToJson(GetFilterWiseAgencyModel data) => json.encode(data.toJson());

class GetFilterWiseAgencyModel {
  GetFilterWiseAgencyModel({
    bool? status,
    String? message,
    List<Data>? data,
  }) {
  ...
  GetFilterWiseAgencyModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  List<Data>? _data;
  GetFilterWiseAgencyModel copyWith({
    bool? status,
    String? message,
    List<Data>? data,
  }) =>
