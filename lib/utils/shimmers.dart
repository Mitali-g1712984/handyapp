...
class Shimmers {
  ...
  static Shimmer homeTopRatedAgencyShimmer() {
    return Shimmer.fromColors(
      baseColor: Constant.baseColor,
      highlightColor: Constant.highlightColor,
      period: Constant.period,
  ...
  static Shimmer appointmentShimmer() {
    return Shimmer.fromColors(
      baseColor: Constant.baseColor,
      highlightColor: Constant.highlightColor,
      period: Constant.period,
  ...
  static Shimmer getAgencyServiceListShimmer() {
    return Shimmer.fromColors(
      baseColor: Constant.baseColor,
      highlightColor: Constant.highlightColor,
      period: Constant.period,
                      ...
                      Expanded(
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Image.asset(AppAsset.icPlaceholderService).paddingAll(30),
                          ),
                        ),
                      ),
                      Column(
